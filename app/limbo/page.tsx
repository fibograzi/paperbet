...
export const metadata: Metadata = {
  title:
    "Free Limbo Game Simulator — Instant Multiplier Prediction with 99% RTP | PaperBet.io",
  description:
    "Play Limbo for free with casino-accurate math. Set your target multiplier, bet, and see if the crash point beats your target. Test strategies like Martingale and D'Alembert risk-free.",
  alternates: {
  ...
  openGraph: {
    title:
      "Free Limbo Game Simulator — Instant Multiplier Prediction with 99% RTP | PaperBet.io",
    description:
      "Play Limbo for free. Set your target multiplier and test betting strategies risk-free with $1,000 in paper money.",
  ...
  twitter: {
    ...
    title:
      "Free Limbo Game Simulator — Instant Multiplier Prediction with 99% RTP | PaperBet.io",
    description:
      "Play Limbo for free. Set your target multiplier and test strategies risk-free.",
...
const structuredData = {
  ...
  description:
    "Free Limbo game simulator with casino-accurate 99% RTP. Set your target multiplier from 1.01x to 10,000x and test strategies like Martingale, D'Alembert, and more with $1,000 in paper money.",
};
